...
public class OssUtil {
    ...
    public String upload(byte[] bytes, String objectName) {
        ...
        try {
            // 创建PutObject请求。
            ossClient.putObject(aliProperties.getBucketName(), objectName, new ByteArrayInputStream(bytes));
        ...
        stringBuilder
                .append(aliProperties.getBucketName())
                .append(".")
                .append(aliProperties.getEndpoint())
                .append("/")
                .append(objectName);
